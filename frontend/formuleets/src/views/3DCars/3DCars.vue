  ...
  <div class="h-screen flex justify-center dark:bg-dark-mode bg-white">
    <div id="render" class="flex justify-center items-center h-screen">
      <div
        v-if="!finish"
        id="loading"
        class="z-10 flex flex-col p-5 items-center justify-center absolute dark:bg-dark-mode bg-white dark:text-white"
      >
        ...
        loader.load(
          ...
          (xhr) => {
            ...
            if (xhr.lengthComputable)
              vueElement.pourcentage = Math.round(
                (xhr.loaded / xhr.total) * 100
              );
            if (vueElement.pourcentage >= 100 && !vueElement.error)
              vueElement.finish = true;
          },
          errorHandler
        );
      },
