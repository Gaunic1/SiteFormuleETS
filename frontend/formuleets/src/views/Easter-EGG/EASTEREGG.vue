<template>
  ...
  <!-- ON PHONE -->
  <div class="lg:hidden h-calc w-full flex justify-center items-center flex-wrap bg-cover bg-fixed
  ...
  <!-- MENU -->
  <div class="hidden lg:flex h-calc w-full justify-center items-center flex-wrap bg-cover bg-fixed bg-center dark:bg-dark-mode bg-white" 
  v-if="!game" 
  lazy-background="/static/easter-egg/fond.svg"> 
