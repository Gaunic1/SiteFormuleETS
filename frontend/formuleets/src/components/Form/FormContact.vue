<template>
  <section
    class="min-h-screen dark:text-white flex flex-col md:flex-row justify-center items-center bg-cover bg-center w-full bg-no-repeat"
  ...
  methods: {
    submitForm(e) {
      ...
      fetch("/", {
        ...
        .catch(
          (error) => (this.formMessage = { type: "error", message: error })
        );
    },
  },
};
